<?php
	...
	$dlevel[$l]['enigma'] = "Level 2. Enigme finale des badges. L'ordre est 345621" ;
	...
	echo "{\"enigma\":\"".$dlevel[$Level]['enigma']."\", \"answer\":\"".$dlevel[$Level]['answer']."\", \"type\":\"".$dlevel[$Level]['type']."\"}" ;
